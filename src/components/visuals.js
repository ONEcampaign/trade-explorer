import {plot, rectY, line, ruleY, text, tip, pointer} from "npm:@observablehq/plot";
...
import {formatValue, formatString, getUnitLabel, getLimits, reshapeDataForTable} from "./utils.js";
...
export function plotSingle(data, width) {
    ...
    formattedData = formattedData.reduce((acc, { year, imports, exports, balance, gdp }) => {
...
export function plotMulti(data, flow, width) {
    ...
    formattedData = formattedData.reduce((acc, { year, partner, imports, exports, balance, gdp }) => {
...
export function tableMulti(data, flow, width) {
    ...
    let groupedData = Object.values(
        data.reduce((acc, { category, partner, imports, exports, balance, gdp }) => {
